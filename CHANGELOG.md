...
### Fixes
- Race Condition: Project Uploaded executed before it was finished to be written on disk
- Projects with `WEB_VIEWER` permission were being displayed in the listing but couldn't be opened.
...
- SpeleoDB was silently skipping if a project was uploaded but not modified. Now shows an explicit error.
