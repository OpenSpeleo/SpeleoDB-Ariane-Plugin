...
commit `7097ca8688954beda1344f64da746bf661ef40b4`, matching the CaveLib
aggregation gitlink. The declared Gradle 9.4.1 wrapper imported both API
gitlinks and completed `./gradlew build test` with Java 25; tests that require
live external services retained their existing intentional skips.
